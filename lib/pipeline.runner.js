        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (buildQueueResult != null) {
                ...
                if (buildQueueResult.validationResults != null && buildQueueResult.validationResults.length > 0) {
                    ...
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () { return yield this.waitForPipeline(buildApi, build.project.id, buildQueueResult.id); }), this.waitPeriod);
                }
            }
        });
    }
    waitForPipeline(buildApi, projectId, buildId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (build.status !== BuildInterfaces_1.BuildStatus.Completed) {
                logger_1.Logger.LogInfo(`Pipeline is not yet competed, waiting... (status: ${build.status})`);
                setTimeout(() => __awaiter(this, void 0, void 0, function* () { return yield this.waitForPipeline(buildApi, projectId, buildId); }), this.waitPeriod);
                return;
            }
