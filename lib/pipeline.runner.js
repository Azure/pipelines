...
class PipelineRunner {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.Logger.LogInfo("project url is - " + this.taskParameters.azureDevopsProjectUrl);
                ...
                logger_1.Logger.LogInfo("project url input is - " + this.taskParameters.azureDevopsProjectUrl);
                let webApi = new azdev.WebApi(collectionUrl, authHandler);
                core.info("Connection created");
                if (!webApi) {
                    logger_1.Logger.LogInfo("WebApi is null");
                }
                ...
                try {
                    ...
                    logger_1.Logger.LogInfo("EXception occurred in executing pipeline. " + error.message);
    ...
    RunDesignerPipeline(webApi) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.Logger.LogInfo("Release flow project url is - " + this.taskParameters.azureDevopsProjectUrl);
            let projectName = url_parser_1.UrlParser.GetProjectName(this.taskParameters.azureDevopsProjectUrl);
            let pipelineName = this.taskParameters.azurePipelineName;
